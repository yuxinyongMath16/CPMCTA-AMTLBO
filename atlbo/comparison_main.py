...
# ================================= 场景参数配置 =================================
def comparative_data_calculation(scenario, init_num, tea_num):
    max_iter = 1000  # 最大迭代次数
    population_size = 50  # 种群规模
    threat_r = 2500  # 威胁半径
    algorithm_name = 'atlbo'
    SCENARIO_DATA = {
        1: {
    ...
    try:
        for i in range(completed, total_runs):
            ...
            # 执行算法
            result = atlbo.main(
                max_iter, population_size, uavs, targets, Obstacles, tea_num, threat_r, scenario, init_num
            )
...
for i in range(16):
    ...
    for j in range(3):
        scenario = i+1
        init_num = j+1
        print('场景', i+1, '初值', j+1, '教师数量', tea_num)
        comparative_data_calculation(scenario, init_num, tea_num)