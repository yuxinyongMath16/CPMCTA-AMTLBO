...
def main(max_iter, population_size, uavs, targets, Obstacles, tea_num, threat_r, scenario, init_solution):
    start = time.time()
    move_air_time = []
    ...
    solutions, resources = generate_initial_population(scenario, init_solution)
    iter_num = 0
    while True:
        if iter_num < 1:
        ...
        if (iter_num + 1) % 100 == 0:
            print('迭代次数：', iter_num)
        solutions, pop_fitness, resources, pop_f1, pop_f2 = population_update.population_update(solutions, resources, uavs, targets, pop_fitness, Obstacles, tea_num, iter_num, max_iter, threat_r, pop_f1, pop_f2)
    ...
    # print('最优f1', pop_f1[optimal_index])
    # print('最优f2', pop_f2[optimal_index])
    end = time.time()
    run_time = end - start
...
if __name__ == '__main__':
    ...
    tea_num = 4
    threat_r = 2500
    optimal_chromosome, return_airport, _, _, _ = main(max_iter, population_size, uavs, targets, Obstacles, tea_num, threat_r)
