...
def main(max_iter, population_size, uavs, targets, Obstacles, threat_r, scenario, init_solution):
    start = time.time()
    move_air_time = []
    ...
    iter_num = 0
    p_best = [[[] for p in range(population_size)], [10000 for p in range(population_size)]]
    while True:
        ...
        solutions = population_update.population_update(solutions, pop_fitness, p_best, targets, uavs)
