...
# ================================= 场景参数配置 =================================
def comparative_data_calculation(scenario, init_num):
    ...
    try:
        for i in range(completed, total_runs):
            ...
            # 执行算法
            result = mga.main(targets, uavs, Obstacles, population_size, max_iter, Ne, Ncr, Nm, threat_r, scenario, init_num)
...
for i in range(16):
    for j in range(3):
        ...
        init_num = j+1
        print('场景', i + 1, '初值', j + 1)
        comparative_data_calculation(scenario, init_num)
