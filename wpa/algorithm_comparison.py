...
for i in range(10):
    print('第', i, '次实验开始++++++++++++++++++++++++++++++++++++++++++')
    optimal_chromosome, iteration_optimal_value, run_time, iteration_f1, iteration_f2 = wpa.main(max_iter, population_size, uavs, targets, Obstacles, n_star, threat_r)
...
# print('迭代时间平均值', np.mean(run_time_set))
