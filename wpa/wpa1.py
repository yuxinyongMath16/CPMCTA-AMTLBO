...
def main(max_iter, population_size, uavs, targets, Obstacles, n_star, threat_r, scenario, init_solution):
    start = time.time()
    move_air_time = []
    ...
    while True:
        ...
        solutions = population_update.population_update(solutions, resources, pop_fitness, n_star, targets, uavs)
...
if __name__ == '__main__':
    ...
    max_iter = 100
    threat_r = 2500
    optimal_chromosome, return_airport, _ = main(max_iter, population_size, uavs, targets, Obstacles, n_star, threat_r)
